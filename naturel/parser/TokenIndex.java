...
class TokenIndex extends AnalysisAdapter
{
    ...
    @Override
    public void caseTHashHash(@SuppressWarnings("unused") THashHash node)
    {
        this.index = 8;
    }
    ...
    @Override
    public void caseTBarEqual(@SuppressWarnings("unused") TBarEqual node)
    {
        this.index = 15;
    }
    ...
    @Override
    public void caseTFloatSequence(@SuppressWarnings("unused") TFloatSequence node)
    {
        this.index = 47;
    }

    @Override
    public void caseTDigitSequence(@SuppressWarnings("unused") TDigitSequence node)
    {
        this.index = 48;
    }
